...
makePipe = lambda cellInfo, pos : Pipe(cellInfo[0], cellInfo[1], position=Position(*pos))
makeSource = lambda cellInfo, pos : Pipe(cellInfo[0], cellInfo[1], position=Position(*pos), source=True)
